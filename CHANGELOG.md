...
### Changed
- Bump fairdatapoint extension to v1.7.2 by @Quinten in f6b389a
- Pin setuptools below 82 in CKAN images by @Quinten in 194099f


## [v1.4.5] - 2026-07-20

### Changed
- doc: update CHANGELOG.md for v1.4.4 by @LNDS-Sysadmins in 7b548f9


## [v1.4.4] - 2026-07-08

### Changed
- Update ckanext-gdi-userportal by @Quinten in 189f390
- doc: update CHANGELOG.md for v1.4.3 by @LNDS-Sysadmins in b173d7d
...
### Changed
- Update CHANGELOG.md by @Hans-Christian in 019eca8
- Patch ckan by @Hans-christian in 91c5fbd
- doc: update CHANGELOG.md for v1.3.43 by @LNDS-Sysadmins in e227fa8
- doc: update CHANGELOG.md for v1.3.42 by @LNDS-Sysadmins in 318ee42
